<!-- The Modal -->
<div class="modal fade" id="createDeanModal" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">New Dean</h5>
                <button type="button" class="btn-close bg-dark" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                <div class="modal-body">  
                    
                    <div class="alert alert-info" style="display: none;" id='processing-dean'></div>
                        <form action="" id="create-dean" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="photo" class="form-control mb-2" onchange="createDeanProfilePhoto(this)" id="create-dean-photo" required>
...
<script>
    ...
    const createInput = document.querySelector('#create-dean-photo');
