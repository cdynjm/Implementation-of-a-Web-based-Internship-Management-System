<!-- The Modal -->
<div class="modal fade" id="editCoordinatorModal" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Coordinator</h5>
                <button type="button" class="btn-close bg-dark" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                <div class="modal-body">  
                    
                    <div class="alert alert-info" style="display: none;" id='edit-processing-coordinator'></div>
                        <form action="" id="update-coordinator" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="photo" id="update-coordinator-photo" class="form-control mb-2" onchange="updateCoordinatorProfilePhoto(this)">
...
<script>
    ...
    const updateInput = document.querySelector('#update-coordinator-photo');
