<!-- The Modal -->
<div class="modal fade" id="editHTEModal" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update HTE/Company</h5>
                <button type="button" class="btn-close bg-dark" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                <div class="modal-body">  
                    
                    <div class="alert alert-info" style="display: none;" id='edit-processing-hte'></div>
                        <form action="" id="update-hte" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control mb-2" name="contact_person" id="edit-contact-person" required>
                                    ...
                                    <input type="file" name="photo" id="update-hte-photo" class="form-control mb-2" onchange="updateCoordinatorProfilePhoto(this)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control mb-2" name="slot" id="edit-slot" readonly>
                                </div>
                            </div>
...
<script>
    ...
    const updateInput = document.querySelector('#update-hte-photo');
